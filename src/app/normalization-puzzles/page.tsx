...
import NormalizationPuzzleClient from './NormalizationPuzzleClient.tsx';

export const metadata = {
  title: 'Normalization Puzzle | SQLArcade',
  description: 'Master 1NF, 2NF, and 3NF through interactive puzzles.',
};

export default function Page() {
  return (
    // The Suspense boundary is mandatory for useSearchParams() during Vercel builds
    <Suspense fallback={
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div>
      </div>
    }>
      <NormalizationPuzzleClient />
    </Suspense>
  );
}