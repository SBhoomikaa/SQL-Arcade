...
//     // Listen for custom event to re-run the effect
...
//     };
//   }, []); // Empty dependency array means this runs once on mount and then only on event
...
//                       <Link href={`/quests/${quest.id}`}>{isCompleted ? 'Retry Quest' : 'Start Quest'}</Link>
//                     </Button>
//                   </CardFooter>
//                 </Card>
//               )
...
import { Suspense } from 'react'
import { MainLayout } from '@/components/layout/main-layout'
import QuestsClient from './QuestsClient.tsx'
