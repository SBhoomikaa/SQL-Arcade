      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Convert your plain English questions into SQL queries using a sample schema.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button onClick={handleGenerateSql} disabled={isLoading} className="w-full md:w-auto">
                {isLoading ? (
